...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>USERS.TG_CHAT_ID</code>.
     */
    public final TableField<UsersRecord, Long> TG_CHAT_ID = createField(DSL.name("TG_CHAT_ID"), SQLDataType.BIGINT.nullable(false), this, "");
