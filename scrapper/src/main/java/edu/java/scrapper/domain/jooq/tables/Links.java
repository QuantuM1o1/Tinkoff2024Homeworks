...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_ACTIVITY = createField(DSL.name("LAST_ACTIVITY"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
    ...
    public List<ForeignKey<LinksRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FL_LINKS_SITES);
    }
    ...
    public LinksSites linksSites() {
        if (_linksSites == null)
            _linksSites = new LinksSites(this, Keys.FL_LINKS_SITES);
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super Integer, ? super Integer, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super Integer, ? super Integer, ? super Integer, ? extends U> from) {
